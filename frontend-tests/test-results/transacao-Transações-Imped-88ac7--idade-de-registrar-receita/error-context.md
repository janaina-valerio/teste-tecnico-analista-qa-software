...
- Name: transacao.spec.ts >> Transações >> Impede menor de idade de registrar receita
- Location: transacao.spec.ts:9:7
...
Call log:
  - waiting for getByRole('option', { name: 'Miguel Mendes' }).first() to be visible
