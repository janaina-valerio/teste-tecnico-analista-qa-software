...
- Name: pessoas.spec.ts >> Pessoas >> Criar pessoa maior de idade
- Location: pessoas.spec.ts:15:7
...
Locator: getByRole('row').filter({ hasText: 'Janaína Valério' })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('row').filter({ hasText: 'Janaína Valério' })
    ...
    - main [ref=e39]:
      - generic [ref=e40]:
        ...
        - generic [ref=e44]:
          ...
          - generic [ref=e111]:
            - generic [ref=e112]: Mostrando 1 - 8 de 119
            - generic [ref=e113]:
