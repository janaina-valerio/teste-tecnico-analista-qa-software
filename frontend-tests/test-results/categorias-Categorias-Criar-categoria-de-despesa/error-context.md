...
- Name: categorias.spec.ts >> Categorias >> Criar categoria de despesa
- Location: categorias.spec.ts:15:7
...
Locator: getByRole('row').filter({ hasText: 'Plano de Saúde' })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('row').filter({ hasText: 'Plano de Saúde' })
    ...
    - main [ref=e39]:
      - generic [ref=e40]:
        ...
        - generic [ref=e44]:
          ...
          - generic [ref=e77]:
            - generic [ref=e78]: Mostrando 1 - 8 de 102
            - generic [ref=e79]:
